...
let personne = {
    ...
    payerArticle(article, lieu) {
        if (this.argent>article.prix) {
            ...
            console.log(`${personne.nom} n'a pas assez d'argent. Retour maison`);
        }
...
let poele = {
    ...
    cuire(melange){
        // etat pas cuit
        this.contenu[0].etat= "pas cuit";
        console.log(this.contenu[0].etat= "pas cuit");
        ...
        setTimeout(() => {
            ...
            console.log(this.contenu[0].etat = "cuite");
        }, 4000);
    },
};
...
let articles= [oignon,oeuf,epices,fromage];
...
articles.forEach(element => {
    console.log(`${personne.nom} achete ${element.nom} au prix de ${element.prix} euro`);
});
...
// direction maison
personne.seDeplacer(magasin,maison);

// je rempli mon bol
// je n'arrive pas a ciblé ma main droite
// console.log(personne.mainGauche[0]);
// personne.mainDroite[0].contenu.forEach(element => {
//     personne.remplirBol(element,bol);
...
// retour magasin
personne.seDeplacer(maison,magasin);

// je depose mon panier
magasin.paniers.unshift(personne.mainDroite[0]);
personne.mainDroite.pop();

// retour a nouveau maison
personne.seDeplacer(magasin,maison);
